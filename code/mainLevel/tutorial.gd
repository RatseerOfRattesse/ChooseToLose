...
var printedchars = 0
var tutorialText = ["","PRESS [ENTER] FOR NEXT LINE", "[WASD] OR [ARROW KEYS] TO MOVE", 
"[LEFT CLICK] TO SHOOT", 
"DEFEAT ALL OF THE DREAM-ADVERTISEMENTS (PATENT PENDING)", 
"YOU HAVE [3] LIVES. LOSE THEM ALL AND YOU SHALL SUCCUMB TO \n CORPORATE PERSUASION."]
